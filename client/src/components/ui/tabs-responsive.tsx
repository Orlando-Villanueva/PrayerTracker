...
>(({ className, ...props }, ref) => {
  ...
  return (
    <TabsPrimitive.List
      ref={ref}
      className={cn(
        "flex w-full rounded-md bg-muted/30 border",
        isMobile ? "overflow-x-auto scrollbar-hide border" : "",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-[0_1px_1px_rgba(0,0,0,0.1)] data-[state=active]:border",
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Content
    ref={ref}
    className={cn(
      "mt-2 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 border rounded-md p-2",
      className
    )}
    {...props}
  />
